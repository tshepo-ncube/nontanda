      ...
      <div className="bg-white-100 p-18 mt-10">
          <div className="container mx-auto text-center">
              ...
              <p className="text-gray-600 leading-loose mb-8">
                  We are passionate about mindfulness and committed to helping individuals on their journey to a more mindful life.
                  Our focus extends to creating mindful content, developing thoughtful products, and offering services designed to cultivate mindfulness.
                  By integrating mindfulness into various aspects of life, we aim to empower people to lead more conscious and fulfilling lives.
              </p>
              <p className="text-gray-600 leading-loose">
                  Whether through our engaging content, purposeful products, or transformative services, we strive to be your companion in the mindful business.
                  Join us in the pursuit of mindfulness and discover the positive impact it can have on your well-being.
              </p>
          </div>
      </div>
